...
func TestCreatePacketWithMemo(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			nextMemo:           "",
			expMemo:            "{\"wasm\":{\"contract\":\"evmos1vl0x3xr0zwgrllhdzxxlkal7txnnk56q3552x7\",\"msg\":{\"osmosis_swap\":{\"output_denom\":\"dhives\",\"slippage\":{\"twap\":{\"slippage_percentage\":\"10\",\"window_seconds\":30}},\"receiver\":\"evmos1vl0x3xr0zwgrllhdzxxlkal7txnnk56q3552x7\",\"on_failed_delivery\":\"do_nothing\"}}}}",
		},
		{
			...
			expMemo:            "{\"wasm\":{\"contract\":\"evmos1vl0x3xr0zwgrllhdzxxlkal7txnnk56q3552x7\",\"msg\":{\"osmosis_swap\":{\"output_denom\":\"dhives\",\"slippage\":{\"twap\":{\"slippage_percentage\":\"10\",\"window_seconds\":30}},\"receiver\":\"evmos1vl0x3xr0zwgrllhdzxxlkal7txnnk56q3552x7\",\"on_failed_delivery\":\"do_nothing\",\"next_memo\":\"a next memo\"}}}}",
		},
		{
...
func TestValidateInputOutput(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:         "fail - input equal to output dhives",
			inputDenom:   utils.BaseDenom,
			outputDenom:  utils.BaseDenom,
			stakingDenom: utils.BaseDenom,
			portID:       portID,
...
func TestConvertToOsmosisRepresentation(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:     "pass - correct conversion of dhives",
