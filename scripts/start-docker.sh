...
"$($BINARY_PATH keys show $KEY -a --home $DATA_DIR --keyring-backend test)" 1000000000000000000stake,1000000000000000000dhives \
--home $DATA_DIR --keyring-backend test
echo "prepare genesis: Sign genesis transaction"
$BINARY_PATH gentx $KEY 1000000000000000000stake --keyring-backend test --home $DATA_DIR --keyring-backend test --chain-id $CHAINID
